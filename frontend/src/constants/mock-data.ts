...
(function () {
  ...
  // ---------- Courses (12) ----------
  // id khớp với UUID trong DB seed (V2__seed_data.sql)
  const courses = [
    { id:"20000000-0000-0000-0000-000000000001", title:"Java Spring Boot từ Zero đến Hero", cat:"Backend", instructor:"Nguyễn Văn An", thumb:T.java, students:842, lessons:48, hours:32, level:"Trung cấp", rating:4.8, progress:68, sStatus:"learning", pubStatus:"published", chapters:8 },
    { id:"20000000-0000-0000-0000-000000000002", title:"PostgreSQL Nâng Cao & Query Optimization", cat:"Database", instructor:"Nguyễn Văn An", thumb:T.data1, students:1204, lessons:52, hours:38, level:"Nâng cao", rating:4.7, progress:12, sStatus:"learning", pubStatus:"published", chapters:9 },
    { id:"20000000-0000-0000-0000-000000000003", title:"ReactJS & TailwindCSS Thực Chiến", cat:"Frontend", instructor:"Trần Thị Bình", thumb:T.react, students:967, lessons:60, hours:45, level:"Trung cấp", rating:4.9, progress:100, sStatus:"done", pubStatus:"published", chapters:10 },
    { id:"20000000-0000-0000-0000-000000000004", title:"Docker & Kubernetes Cơ Bản", cat:"DevOps", instructor:"Trần Thị Bình", thumb:T.card1, students:653, lessons:36, hours:24, level:"Cơ bản", rating:4.6, progress:0, sStatus:"new", pubStatus:"published", chapters:6 },
    { id:"20000000-0000-0000-0000-000000000005", title:"RAG với LangChain và OpenAI", cat:"AI/ML", instructor:"Nguyễn Văn An", thumb:T.data2, students:1089, lessons:40, hours:28, level:"Nâng cao", rating:4.8, progress:54, sStatus:"learning", pubStatus:"published", chapters:7 },
